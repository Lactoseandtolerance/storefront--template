...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Improve your visibility in search engines and drive more qualified traffic to your website. Our SEO services help your business get found by potential customers when they are searching for the products or services you offer.",
      icon: '📈',
      features: [
